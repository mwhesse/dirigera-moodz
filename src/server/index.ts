...
class Server {
  ...
  private setupRoutes(): void {
    ...
    const lightsController = new LightsController(this.dirigeraService, this.syncEngine, this.sceneEngine, logger);
    ...
    // Scene routes
    this.app.get('/api/scenes', lightsController.getScenes);
    this.app.post('/api/scenes/start', lightsController.startScene);
    this.app.post('/api/scenes/stop', lightsController.stopScene);
